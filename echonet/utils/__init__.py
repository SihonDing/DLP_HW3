...
def loadvideo(filename: str) -> np.ndarray:
    ...
    #  VideoCapture()中参数是0，表示打开笔记本的内置摄像头，参数是视频文件路径，表示打开视频
    ...
    for count in range(frame_count):
        ...
        # 其中ret是布尔值，如果读取帧是正确的则返回True，如果文件读取到结尾，它的返回值就为False。frame就是每一帧的图像，是个三（四）维矩阵
        ...
        v[count, :, :] = frame
    # v.shape = (3, frame_count, frame_height, frame_width)
